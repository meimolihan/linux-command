...
[Git常用命令清单](https://github.com/jaywcjlove/handbook/blob/master/other/Git%E5%B8%B8%E7%94%A8%E5%91%BD%E4%BB%A4%E6%B8%85%E5%8D%95.md "GitHub 代码托管平台")
...
[Github教程同步fork教程](https://help.github.com/articles/syncing-a-fork/ "GitHub 同步 Fork 教程")，[在Github上同步一个分支(fork)](http://www.miss77.net/549.html)  
...
[Pretty Formats](https://git-scm.com/docs/git-log#_pretty_formats "Git 官方文档")
...
[Github官方教程](https://help.github.com/articles/changing-author-info/ "GitHub 修改提交作者信息")
...
- [Git官网](http://git-scm.com/ "Git 官方网站")
- [**Github 15分钟学习Git**](https://try.github.io "GitHub 15分钟学习 Git")
- [Git参考手册](http://gitref.org/zh/index.html "Git 参考手册（中文）")
- [Git简明手册](http://www.mceiba.com/tool/git-cheat-sheet.html "Git 速查表")
- [Git Magic](http://www-cs-students.stanford.edu/~blynn/gitmagic/intl/zh_cn/ "Git Magic（中文）")
- [Git Community Book 中文版](http://gitbook.liuhui998.com/index.html "Git Community Book（中文）")
- [Pro Git](http://git-scm.com/book/en/v2 "Git 官方网站")
- [图解Git](http://marklodato.github.io/visual-git-guide/index-zh-cn.html "图解 Git")
- [git-简明指南](http://rogerdudler.github.io/git-guide/index.zh.html "Git 简明指南（中文）")
- [learnGitBranching 在线学习工具](http://pcottle.github.io/learnGitBranching/)
- [初级教程](http://rogerdudler.github.io/git-guide/index.zh.html "Git 简明指南（中文）")
- [廖雪峰的Git教程](http://www.liaoxuefeng.com/wiki/0013739516305929606dd18361248578c67b8067c8c017b000)
- [蒋鑫老师将带你入github的大门](http://www.worldhello.net/gotgithub/ "GotGitHub 教程")
- [git详解](http://www.open-open.com/lib/view/open1328069609436.html)
- [oschina教程](http://git.oschina.net/progit/)
- [How to undo (almost) anything with Git撤销一切，汇总各种回滚撤销的场景，加强学习。](https://github.com/blog/2019-how-to-undo-almost-anything-with-git "GitHub 代码托管平台")
- [Git 教程 | 菜鸟教程runoob.com](http://www.runoob.com/git/git-tutorial.html)
- [Git 本地仓库和裸仓库](https://gold.xitu.io/post/5842f9b861ff4b005889ade6 "稀土掘金文章")
- [沉浸式学 Git](http://www.kancloud.cn/kancloud/igit/46710 "看云 Git 教程")
