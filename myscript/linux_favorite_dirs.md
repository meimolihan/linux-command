...
```bash
bash <(curl -sL gitee.com/meimolihan/linux-command_sh/raw/master/linux_favorite_dirs.sh)
```

## 效果预览

![执行脚本效果预览](https://file.meimolihan.eu.org/screenshot/linux_favorite_dirs.webp "截图演示")

## 补充说明

该脚本是Linux常用目录文件管理工具，提供交互式菜单操作，支持39项文件管理功能，可快速访问和管理常用目录，支持收藏常用目录。

### 功能特点

* 交互式菜单操作，支持39项文件管理操作
* 支持收藏常用目录，快速访问
* 支持通过参数指定工作目录（-w/--workdir）
* 提供完善的帮助信息（-h/--help）
* 包含文件复制、移动、删除、重命名等基本操作
* 彩色输出，清晰展示操作状态
* 支持文件搜索、权限修改等高级功能
* 显示当前目录结构和文件详细信息
